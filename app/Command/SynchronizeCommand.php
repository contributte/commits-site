...
final class SynchronizeCommand extends Command
{
	...
	public function __construct(Lock $lock, CommitSynchronizer $commitSynchronizer)
	{
		parent::__construct();
	...
	{
		$this->setName('synchronize')
			->setDescription('Synchronizes commits in all repositories.');
	}
